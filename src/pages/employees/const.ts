...
export const basicInfoFields = [
  ...
  { key: "dateOfBirth", label: "Date of Birth (In Certificate)", type: "date" },
...
export const employeeColumns = [
  ...
  { key: "noticePeriod", label: "Notice Period (days)", type: "number", disabled: true },
  ...
  { key: "template", label: "Shift Common Template", type: "select" },
  ...
  { key: "oldIdNo", label: "Old Reference ID Number" },
