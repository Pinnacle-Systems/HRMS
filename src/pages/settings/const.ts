export const companyFieldsWithSections = [
  ...
  { key: 'costCode', label: 'Cost Code', type: 'text', placeholder: '(e.g., CC2024001)' },
...
//   { key: 'twitterHandle', label: 'Twitter Handle', type: 'text', placeholder: '(e.g., @companyname)' },
  ...
  { key: 'pfNo', label: 'PF Code', type: 'text', placeholder: 'MH/12345/1234 (15-20 characters)' },
  { key: 'esiNo', label: 'ESI Code', type: 'text', placeholder: '12345678901234567 (17 digits)' },
