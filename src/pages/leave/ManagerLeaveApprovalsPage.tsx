...
import { AttachFileOutlined, CheckCircleOutlineOutlined, FolderOutlined, GroupOutlined, MoreVertOutlined, Person2Outlined, WorkOutlineOutlined } from "@mui/icons-material";
...
export default function ManagerLeaveApprovalsPage() {
  ...
  const submitAction = async () => {
    ...
    showSpinner();
    try {
      const payload: any = { comments: comments || "Approved by manager",lopLeaveTypeId: actionDialog.request.leaveTypeId };
      const response =
  ...
  return (
    ...
    >
      ...
      <TableContainer
        className="max-w-full overflow-auto h-[calc(100vh-430px)]"
      >
                ...
                <TableRow key={request.id} sx={getRowColor(i)}>
                  ...
                  <TableCell>
                    ...
                    {request.status === "PENDING" && (
                      <Tooltip title="More">
                        <IconButton size="small" onClick={(event) => openActionMenu(event, request)}>
      ...
      >
        {selectedRequest && (
          <div className="space-y-6">
            {/* Status Banner */}
            {(detailCalculation?.insufficientBalance || (detailCalculation?.warnings && detailCalculation?.warnings?.length > 0)) && (
              <div className={`p-3 rounded-lg border-l-4 ${detailCalculation?.insufficientBalance
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className={`text-xs font-semibold ${detailCalculation?.insufficientBalance ? 'text-amber-800' : 'text-blue-800'
                      }`}>
                      {detailCalculation?.insufficientBalance
                    ...
                    {detailCalculation?.warnings?.map((warning, index) => (
                      <div key={index} className={`text-[11px] mt-0.5 ${detailCalculation?.insufficientBalance ? 'text-amber-700' : 'text-blue-700'
                        }`}>
                        • {warning}
                      </div>
                    ))}
                    {detailCalculation?.insufficientBalance && (
                      <div className="text-[11px] text-amber-700 mt-1 font-medium">
                        {detailCalculation.potentialLop} days may be converted to Loss of Pay (LOP)
                      </div>
                    )}
                  </div>
                </div>
            ...
            <div className="grid grid-cols-4 gap-3">
              <div className="bg-blue-50 rounded-lg p-3 border border-blue-100">
                ...
                <div className="text-lg font-bold text-blue-700 mt-0.5">
                  {detailCalculation?.calculatedDays || selectedRequest.days}
                </div>
              </div>
              <div className="bg-green-50 rounded-lg p-3 border border-green-100">
                <div className="text-[12px] text-green-600">Available Balance</div>
                <div className={`text-lg font-bold mt-0.5 ${(detailBalance?.closingBalance || 0) < (detailCalculation?.calculatedDays || 0)
                  ? 'text-red-600'
                  : 'text-green-700'
                  }`}>
              ...
              <div className="bg-purple-50 rounded-lg p-3 border border-purple-100">
                ...
                <div className={`text-lg font-bold mt-0.5 ${(detailCalculation?.balanceAfter || 0) < 0 ? 'text-red-600' : 'text-purple-700'
                  }`}>
              ...
              <div className="bg-amber-50 rounded-lg p-3 border border-amber-100">
                ...
                <div className={`text-lg font-bold mt-0.5 ${(detailCalculation?.potentialLop || 0) > 0 ? 'text-amber-700' : 'text-green-700'
                  }`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div className="border border-gray-200 rounded-lg p-4 bg-white">
                <div className="flex items-center gap-2 mb-3 pb-2 border-b border-gray-200">
                  ...
                  <h3 className="text-[12px] font-semibold text-gray-800">Employee Summary</h3>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-center py-1">
                    <span className="text-[11px] text-gray-500">Employee Code</span>
                    <span className="text-[11px] text-gray-800">{selectedRequest.employeeCode}</span>
                  </div>
                  <div className="flex justify-between items-center py-1">
                    <span className="text-[11px] text-gray-500">Department</span>
                    <span className="text-[11px] text-gray-800">{selectedRequest.department}</span>
                  </div>
                  <div className="flex justify-between items-center py-1">
                    <span className="text-[11px] text-gray-500">Location</span>
                    <span className="text-[11px] text-gray-800">{selectedRequest.location}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="border border-gray-200 rounded-lg p-4 bg-white">
                <div className="flex items-center gap-2 mb-3 pb-2 border-b border-gray-200">
                  ...
                  <h3 className="text-[12px] font-semibold text-gray-800">Leave Details</h3>
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between items-center py-1">
                    <span className="text-[11px] text-gray-500">Leave Type</span>
                    <span className="text-[11px] text-gray-800 font-medium">
                      {selectedRequest.leaveTypeName} ({selectedRequest.leaveTypeCode})
                    </span>
                  </div>
                  <div className="flex justify-between items-center py-1">
                  ...
                  <div className="flex justify-between items-center py-1">
                    <span className="text-[11px] text-gray-500">Days Requested</span>
                    <span className="text-[11px] text-gray-800 font-medium">
                      {detailCalculation?.calculatedDays || selectedRequest.days}
                    </span>
                  </div>
              ...
              <div className="border border-gray-200 rounded-lg p-4 bg-white">
                <div className="flex items-center gap-2 mb-3 pb-2 border-b border-gray-200">
                  ...
                  <h3 className="text-[12px] font-semibold text-gray-800">Leave Balance</h3>
                </div>
                {detailBalance ? (
                  <div className="space-y-2">
                    <div className="flex justify-between items-center py-1">
                      <span className="text-[11px] text-gray-500">Opening Balance</span>
                      <span className="text-[11px] text-gray-800">{detailBalance.openingBalance}</span>
                    </div>
                    <div className="flex justify-between items-center py-1">
                      <span className="text-[11px] text-gray-500">Accrued</span>
                      <span className="text-[11px] text-green-600">+{detailBalance.accruedDays}</span>
                    </div>
                    <div className="flex justify-between items-center py-1">
                      <span className="text-[11px] text-gray-500">Consumed</span>
                      <span className="text-[11px] text-red-600">-{detailBalance.consumedDays}</span>
                    </div>
                    <div className="flex justify-between items-center py-1 border-t border-gray-200 pt-2">
                      <span className="text-[11px] font-medium text-gray-700">Available Balance</span>
                      <span className={`text-sm font-bold ${detailBalance.closingBalance < (detailCalculation?.calculatedDays || 0)
                        ? 'text-red-600'
                        : 'text-green-600'
                        }`}>
                  ...
                  <div className="text-[11px] text-gray-500 text-center py-4">No balance information available</div>
                )}
              </div>
              ...
              <div className="border border-gray-200 rounded-lg p-4 bg-white">
                <div className="flex items-center gap-2 mb-3 pb-2 border-b border-gray-200">
                  ...
                  <h3 className="text-[12px] font-semibold text-gray-800">Leave Impact</h3>
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between items-center py-1">
                    <span className="text-[11px] text-gray-500">Current Balance</span>
                    <span className="text-[11px] text-gray-800 font-medium">
                      {detailCalculation?.currentBalance ?? 'N/A'}
                    </span>
                  </div>
                  <div className="flex justify-between items-center py-1">
                    <span className="text-[11px] text-gray-500">Balance After Leave</span>
                    <span className={`text-[11px] font-medium ${(detailCalculation?.balanceAfter || 0) < 0 ? 'text-red-600' : 'text-green-600'
                      }`}>
                      {detailCalculation?.balanceAfter ?? 'N/A'}
                    </span>
                  </div>
                  <div className="flex justify-between items-center py-1">
                    <span className="text-[11px] text-gray-500">Potential LOP</span>
                    <span className={`text-[11px] font-medium ${(detailCalculation?.potentialLop || 0) > 0 ? 'text-amber-600' : 'text-green-600'
                      }`}>
                      {detailCalculation?.potentialLop || 0}
                    </span>
                  </div>
                  <div className="flex justify-between items-center py-1 border-t border-gray-200 pt-2">
                    <span className="text-[11px] text-gray-500">Payroll Treatment</span>
                    <span className={`text-[11px] font-medium px-2 py-0.5 rounded ${detailCalculation?.payrollTreatment === 'PAID'
                      ? 'bg-green-100 text-green-700'
                      : 'bg-amber-100 text-amber-700'
                      }`}>
                      {detailCalculation?.payrollTreatment || 'N/A'}
                    </span>
                  </div>
                </div>
              </div>
              ...
              {detailCalculation?.dayBreakdown && detailCalculation.dayBreakdown.length > 0 && (
                <div className="lg:col-span-2 border border-gray-200 rounded-lg p-4 bg-white">
                  <div className="flex items-center gap-2 mb-3 pb-2 border-b border-gray-200">
                    <CalendarIcon className="w-4 h-4 text-primary" />
                    <h3 className="text-[12px] font-semibold text-gray-800">Day Breakdown</h3>
                  </div>
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                    {detailCalculation.dayBreakdown.map((day, index) => (
                      <div key={index} className={`p-2.5 rounded border ${day.holiday || day.weeklyOff ? 'bg-gray-50 border-gray-200' : 'bg-blue-100/50 border-blue-200'
                        }`}>
                        <div className="text-[11px] font-medium text-gray-800">
                          {formatDate(day.date)}
                        </div>
                        <div className="text-[10px] text-gray-600 mt-0.5">
                          {day.session} • {day.days} day{day.days > 1 ? 's' : ''}
                        </div>
                  ...
                  <div className="mt-3 p-2 bg-gray-50 rounded border border-gray-200">
                    <div className="text-[10px] text-gray-600 flex items-center flex-wrap gap-3">
                      ...
                      <span className="bg-white px-2 py-0.5 rounded border border-gray-200">
                        {detailCalculation.policyApplied?.weeklyOffInclusion === 'EXCLUDE' ? 'Weekends excluded' : 'Weekends included'}
                      </span>
                      <span className="bg-white px-2 py-0.5 rounded border border-gray-200">
                        {detailCalculation.policyApplied?.holidayInclusion === 'EXCLUDE' ? 'Holidays excluded' : 'Holidays included'}
                      </span>
                      {detailCalculation.policyApplied?.sandwichRule == true ? (
                        <span className="bg-white px-2 py-0.5 rounded border border-gray-200">
              ...
              <div className="border border-gray-200 rounded-lg p-4 bg-white">
                <div className="flex items-center gap-2 mb-3 pb-2 border-b border-gray-200">
                  ...
                  <h3 className="text-[12px] font-semibold text-gray-800">Team Overlap</h3>
                  {teamOverlap.length > 0 && (
                    <span className="ml-auto text-[10px] bg-amber-100 text-amber-700 px-2 py-0.5 rounded-full font-medium">
                      {teamOverlap.length} {teamOverlap.length === 1 ? 'member' : 'members'}
                    </span>
                  )}
                </div>
                {teamOverlap.length > 0 ? (
                  <div className="space-y-2 max-h-32 overflow-y-auto pr-1">
                    {teamOverlap.map((item) => (
                      <div key={item.id} className="p-2 bg-amber-100/50 rounded border border-amber-200">
                        <div className="flex justify-between items-start">
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="text-[10px] text-gray-600 mt-0.5">
                              {item.leaveTypeCode} • {formatDate(item.fromDate)} - {formatDate(item.toDate)}
                            </div>
                          </div>
                          <span className="text-amber-500 text-xs ml-2">⚠️</span>
                        </div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="flex items-center gap-2 text-gray-500 justify-center py-4">
                    ...
                    <span className="text-[11px]">No overlapping team leave found</span>
                  </div>
                )}
              </div>
              ...
              <div className="border border-gray-200 rounded-lg p-4 bg-white">
                <div className="flex items-center gap-2 mb-3 pb-2 border-b border-gray-200">
                  ...
                  <h3 className="text-[12px] font-semibold text-gray-800">Reason</h3>
                </div>
              ...
              <div className="border border-gray-200 rounded-lg p-4 bg-white">
                <div className="flex items-center gap-2 mb-3 pb-2 border-b border-gray-200">
                  <ClockIcon className="w-4 h-4 text-primary" />
                  <h3 className="text-[12px] font-semibold text-gray-800">Approval Timeline</h3>
                </div>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-500 mt-1.5 ring-2 ring-green-200 flex-shrink-0"></div>
                    <div>
                      <div className="text-[10px] text-gray-500 uppercase tracking-wider">Submitted</div>
                      <div className="text-[11px] text-gray-800 font-medium">
                        {formatDate(selectedRequest.appliedOn)}
                      </div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                  ...
                  {selectedRequest.approverRemarks && (
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <div className="text-[10px] text-gray-500 uppercase tracking-wider">Remarks</div>
              ...
              <div className="border border-gray-200 rounded-lg p-4 bg-white">
                <div className="flex items-center gap-2 mb-3 pb-2 border-b border-gray-200">
                  ...
                  <h3 className="text-[12px] font-semibold text-gray-800">Attachments</h3>
                </div>
                <div className="flex flex-col items-center justify-center py-6 border-2 border-dashed border-gray-200 rounded bg-gray-50/50">
                  ...
                  <span className="text-[11px] text-gray-500">No attachments uploaded</span>
                </div>
              </div>
