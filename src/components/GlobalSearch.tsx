...
const ALL_ITEMS: SearchItem[] = [
  ...
  },
  {
    ...
    description: "Overview, metrics, KPIs, trends",
    path: "/payroll",
    category: "Payroll",
    icon: <DashboardOutlinedIcon fontSize="small" />,
    keywords: ["payroll", "dashboard", "view", "chart"],
    roles: ["ADMIN", "HR"],
  },
  {
    label: "Payroll Runs",
    description: "Management, status tracking",
    path: "/payroll/runs",
    category: "Payroll",
    icon: <PlayArrowOutlinedIcon fontSize="small" />,
    keywords: ["payroll", "runs", "period", "table"],
    roles: ["ADMIN", "HR"],
  },
  {
    label: "Generate Payroll",
    description: "Wizard, processing, employee selection",
    path: "/payroll/generate",
    category: "Payroll",
    icon: <TrendingUpOutlinedIcon fontSize="small" />,
    keywords: ["payroll", "generate", "run", "period"],
    roles: ["ADMIN", "HR"],
  },
  {
    label: "Employee Payslips",
    description: "View, download, manage",
    path: "/payroll/payslips",
    category: "Payroll",
    icon: <ReceiptLongOutlinedIcon fontSize="small" />,
    keywords: ["payroll", "payslip", "pay", "view", "process"],
    roles: ["ADMIN", "HR"],
  },
  {
    label: "Employee View",
    description: "Structure, history, loans, tax",
    path: "/payroll/employee-salary",
    category: "Payroll",
    icon: <PersonOutlinedIcon fontSize="small" />,
    keywords: ["payroll", "payslip", "download", "view"],
    roles: ["HR", "MANAGER", "ESS"],
  },
  {
    label: "Salary Components",
    description: "Create, manage, earnings, deductions",
    path: "/payroll/components",
    category: "Payroll",
    icon: <CategoryOutlinedIcon fontSize="small" />,
    keywords: ["payroll", "salary", "components", "earnings"],
    roles: ["ADMIN", "HR"],
  },
  {
    label: "Salary Structure",
    description: "Design, templates, publish",
    path: "/payroll/structures",
    category: "Payroll",
    icon: <SchemaOutlinedIcon fontSize="small" />,
    keywords: ["payroll", "salary", "structures", "create", "template"],
    roles: ["ADMIN", "HR"],
  },
  {
    label: "Assign Salary",
    description: "Assign, bulk, CTC breakdown",
    path: "/payroll/assign",
    category: "Payroll",
    icon: <AssignmentOutlinedIcon fontSize="small" />,
    keywords: ["payroll", "salary", "assign", "breakdown"],
    roles: ["ADMIN", "HR"],
  },
  {
    label: "Employee Deductions",
    description: "Loans, advances, recurring",
    path: "/payroll/deductions",
    category: "Payroll",
    icon: <MoneyOffOutlinedIcon fontSize="small" />,
    keywords: ["payroll", "deduction", "config", "view"],
    roles: ["ADMIN", "HR"],
  },
  {
    label: "Payroll Period",
    description: "Create, manage, dates, holidays",
    path: "/payroll/periods",
    category: "Payroll",
    icon: <EventNoteOutlinedIcon fontSize="small" />,
    keywords: ["payroll", "period", "view"],
    roles: ["ADMIN", "HR"],
  },
  {
    label: "Loan / Advance Requests",
    description: "Requests, approval workflow",
    path: "/payroll/loan-advance-request",
    category: "Payroll",
    icon: <RequestPageOutlinedIcon fontSize="small" />,
    keywords: ["loan", "advance", "request", "view"],
    roles: ["ADMIN", "HR"],
  },
  {
    label: "Statutory Compliance",
    description: "PF, ESI, TDS, filing, reports",
    path: "/payroll/compliance",
    category: "Payroll",
    icon: <SecurityOutlinedIcon fontSize="small" />,
    keywords: ["payroll", "statutory", "compliance"],
    roles: ["ADMIN", "HR"],
  },
  {
    label: "Bank Advice",
    description: "NEFT, RTGS, payment files",
    path: "/payroll/bank-advice",
    category: "Payroll",
    icon: <PaymentsOutlinedIcon fontSize="small" />,
    keywords: ["payroll", "bank", "advice"],
    roles: ["ADMIN", "HR"],
  },
  {
    label: "Payroll Reports",
    description: "Generate, export, salary register",
    path: "/payroll/reports",
    category: "Payroll",
    icon: <BarChartOutlinedIcon fontSize="small" />,
    keywords: ["payroll", "generate", "reports"],
    roles: ["ADMIN", "HR"],
  },
  {
    label: "Payroll Audit Logs",
    description: "Activities, changes, audit trail",
    path: "/payroll/audit",
    category: "Payroll",
    icon: <HistoryToggleOffOutlinedIcon fontSize="small" />,
    keywords: ["payroll", "audit", "logs", "track"],
    roles: ["ADMIN", "HR"],
  },
  {
    label: "Portal",
    description: "Self-service, payslips, bank details",
    path: "/payroll/employee-portal",
    category: "Payroll",
    icon: <PeopleAltOutlinedIcon fontSize="small" />,
    keywords: ["payroll", "portal"],
    roles: ["ADMIN", "HR"],
  },
  {
    label: "Salary Revisions",
    description: "List, create, and manage employee salary revisions & increments",
  ...
  // },
  {
    ...
    icon: <SchemaOutlinedIcon fontSize="small" />,
    keywords: [
      "template", "revision", "rule", "increment", "slab",
      "percent", "flat", "rounding", "salary", "appraisal",
    ],
    roles: ["ADMIN", "HR"],
  },
  // {
  ...
  // },
  {
    ...
    icon: <HistoryToggleOffOutlinedIcon fontSize="small" />,
    keywords: [
      "history", "salary", "revision", "past", "increment",
      "audit", "timeline", "raise", "hike", "appraisal",
    ],
