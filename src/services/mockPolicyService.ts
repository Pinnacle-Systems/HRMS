...
export const MOCK_TEMPLATES: PolicyTemplate[] = [
  ...
  {
    id: 'tmpl_bonus',
    name: 'Employee Bonus Policy',
    domain: PolicyDomain.BONUS,
    description: 'Performance and statutory bonus policy — Annual bonus, performance-linked incentives, festival advance, and retention bonus as per Payment of Bonus Act, 1965.',
    configSchema: {},
    defaultConfig: {
      bonusRules: {
        bonusTypes: [
      ...
      approvalFlow: {
        levels: [
          { level: 1, approverType: 'HR', timeoutDays: 3 },
        ],
        autoApproveBelowDays: 0,
        fallbackApprover: 'HR',
        notifyOnSubmit: true,
    ...
    ruleBlocks: [
      { id: 'rb1', name: 'Bonus Configuration', type: 'BONUS_RULES', configurable: true, schema: {} },
      { id: 'rb2', name: 'Approval Workflow', type: 'APPROVAL_FLOW', configurable: true, schema: {} },
    ],
    isSystemTemplate: true,
  },
  ...
  // ── LOAN & ADVANCE DOMAIN ─────────────────────────────────────────────────────
  {
    id: 'tmpl_loan_advance',
    name: 'Employee Loan & Advance Policy',
    domain: PolicyDomain.LOAN_ADVANCE,
    description: 'Employee loan and salary advance policy — Salary advance, personal loans, festival advance, and education loans with EMI deduction from salary.',
    configSchema: {},
    defaultConfig: {
      loanAdvanceRules: {
        loanTypes: [
          ...
          {
            type: 'FESTIVAL_ADVANCE',
            name: 'Festival Advance',
            maxAmount: 20000,
            maxMonthlyMultiplier: 1,
            interestRate: 0,
            maxRepaymentMonths: 5,
            maxEMIPercentage: 30,
            minServiceMonths: 3,
            collateralRequired: false,
            preClosureAllowed: true,
        ...
        deductionFromSalary: true,
      },
      approvalFlow: {
        levels: [
          { level: 1, approverType: 'REPORTING_MANAGER', timeoutDays: 2 },
          { level: 2, approverType: 'HR', timeoutDays: 2 },
          { level: 3, approverType: 'FINANCE', timeoutDays: 3 },
        ],
        autoApproveBelowDays: 0,
        fallbackApprover: 'HR',
        notifyOnSubmit: true,
    ...
    ruleBlocks: [
      { id: 'rb1', name: 'Loan & Advance Configuration', type: 'LOAN_ADVANCE_RULES', configurable: true, schema: {} },
      { id: 'rb2', name: 'Approval Workflow', type: 'APPROVAL_FLOW', configurable: true, schema: {} },
    ],
    isSystemTemplate: true,
  },
